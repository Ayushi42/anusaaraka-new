 ...
 echo "(defglobal ?*wsd_path* = $HOME_anu_test/WSD/telugu_wsd_rules)" >> global_path.clp
 ...
 echo "(language telugu)" >> language.dat
 ...
 cd $MYPATH/$1_tmp/$2
 myclips -f $HOME_anu_test/Anu_clp_files/run_tel_modules_std.bat >  $1.error
...
#------------------------------------------------Teugu_word_generation-------------------------------------------

cp $HOME_anu_tmp/tmp/$1_tmp/$2/id_Apertium_input.dat $HOME/sampark/bin/tl/wordgenerator/tel/tests/ten.rin

cd $setu/bin/tl/wordgenerator/tel
./wordgen_converter.sh tests/ten.rin tests/ten.rout
sh $HOME/anusaaraka/Anu_src/get_tel_morph_out.sh $setu/bin/tl/wordgenerator/tel/tests/ten.rout  $1 $2
