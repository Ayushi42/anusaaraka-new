...
//** Include extract_key.c (Removed 'char input_file []' instead included extract_key.c by Roja)
#include "hi_IN.dic.c"
...
//    printf ("Automata finalized.\n\nSearching...\n");
	...
	int len1=0;
        ...
        while(getline(&line, &len, fp)!=-1)
        {
           printf("%s", line);
	   len1=strcspn(line, "\n");
	   strncpy(str1, line, len1); str1[len1] = ' '; str1[len1+1] = '\0'; //Removing newline and adding space to end of the string
	   s=strchr(str1, '\t')+1;
           strcpy(input_line+1, s);
         //  printf("%s", input_line);
