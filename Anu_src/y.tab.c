...
#line 2 "constituency_parse.y" /* yacc.c:339  */
...
{
       0,    62,    62,    68,    81,    87,    62,   102,   104,   106,
     114
};
#endif
...
{
  "$end", "error", "$undefined", "LEFT_PAREN", "RIGHT_PAREN", "SLASH",
  "TOK_CATEGORY", "STRING", "$accept", "expression", "$@1", "$@2", "$@3",
  "$@4", "sub_expression", YY_NULLPTR
};
#endif
...
{
       1,     1,     1,    12,    11,    14,    15,     4,     5,     9,
       7,    10,    17
};

static const yytype_uint8 yycheck[] =
{
       3,     3,     3,    10,     7,     7,    13,     0,     6,     5,
       7,     6,     4
};
...
yyreduce:
  ...
  switch (yyn)
    {
        case 2:
#line 62 "constituency_parse.y" /* yacc.c:1646  */
    {found=0;my_level++;current_sub_level[my_level]++;
                        for(j=0;j<index1;j++)
...
#line 1265 "y.tab.c" /* yacc.c:1646  */
  ...
  case 3:
#line 68 "constituency_parse.y" /* yacc.c:1646  */
    {//sprintf(str1,"%d\0",my_level);strcat($3,str1);my_token_count++;
                         count=count+1;
                         strcpy(token,(yyvsp[0]));
			 ...
			 sprintf(str2,"%d",my_token_count); str2[strlen(str2)] = '\0';  strcat((yyvsp[0]),str2); 
                         strcpy(my_mother[my_level][current_sub_level[my_level]],(yyvsp[0]));
...
#line 1282 "y.tab.c" /* yacc.c:1646  */
  ...
  case 4:
#line 81 "constituency_parse.y" /* yacc.c:1646  */
    {strcat(my_temp[my_level],(yyvsp[0]));strcat(my_temp[my_level]," ");

                          strcpy(my_head[my_level][current_sub_level[my_level]],(yyvsp[0]));}
#line 1290 "y.tab.c" /* yacc.c:1646  */
    break;

  case 5:
#line 87 "constituency_parse.y" /* yacc.c:1646  */
    {
                          strncpy(my_temp[my_level]+my_opn_parn_loc[my_level]-9,(yyvsp[-6]),strlen((yyvsp[-6])));
                          strcat(my_temp[my_level-1],(yyvsp[-6]));
                          strcat(my_temp[my_level-1]," ");

                          strcat(my_daughters[my_level-1][current_sub_level[my_level-1]],(yyvsp[-6]));
                          strcat(my_daughters[my_level-1][current_sub_level[my_level-1]]," "); }
#line 1302 "y.tab.c" /* yacc.c:1646  */
    break;

  case 6:
#line 95 "constituency_parse.y" /* yacc.c:1646  */
    {
...
#line 1310 "y.tab.c" /* yacc.c:1646  */
  ...
  case 7:
#line 102 "constituency_parse.y" /* yacc.c:1646  */
    {strcpy((yyval),(yyvsp[0]));}
#line 1316 "y.tab.c" /* yacc.c:1646  */
    break;

  case 9:
#line 106 "constituency_parse.y" /* yacc.c:1646  */
    { strcat(my_temp[my_level],(yyvsp[0])); strcat(my_temp[my_level]," ");
                   count1=count1+1;
...
#line 1328 "y.tab.c" /* yacc.c:1646  */
  ...
  case 10:
#line 114 "constituency_parse.y" /* yacc.c:1646  */
    {strcat(my_temp[my_level],(yyvsp[0]));strcat(my_temp[my_level]," ");
                                     count1=count1+1;
        	           	     //sprintf(buffer,"P%d\0",count1);
	  			     //Modified above step as shown below by Roja(11-05-16). To avoid warnings in Ubuntu 14.04 and above
