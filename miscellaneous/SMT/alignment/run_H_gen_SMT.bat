...
; (save-facts "id_Apertium_output_new.dat" local id-Apertium_output)
 ...
 ;confidence_level 5
 (load "global_path.clp")
 (bind ?*path* (str-cat ?*path* "/miscellaneous/SMT/alignment/word_alignment2.clp"))
 (load ?*path*)
 ...
 (save-facts "confidence_level_tmp1.dat" local id-confidence_level)
 (save-facts "anu_aligned_ids_tmp1.dat" local mng_has_been_filled)
 (save-facts "man_aligned_ids_tmp1.dat" local mng_has_been_aligned)
 (clear)
 ;--------------------------------------------------------------------------
 ;confidence_level 4
 (load "global_path.clp")
 (bind ?*path* (str-cat ?*path* "/miscellaneous/SMT/alignment/word_align_with_vib.clp"))
 (load ?*path*)
 (load-facts "word_alignment_tmp1.dat")
 (load-facts "confidence_level_tmp1.dat")
 (load-facts "anu_aligned_ids_tmp1.dat")
 (load-facts "man_aligned_ids_tmp1.dat")
 (load-facts "aper_op_without_@.dat")
 (load-facts "hindi_meanings.dat")
 (load-facts "manual_lwg.dat")
 (load-facts "GNP_agmt_info.dat")
 ...
 (save-facts "confidence_level_tmp2.dat" local id-confidence_level)
 (save-facts "anu_aligned_ids_tmp2.dat" local mng_has_been_filled)
 (save-facts "man_aligned_ids_tmp2.dat" local mng_has_been_aligned)
 (clear)
 ;--------------------------------------------------------------------------
 (load "global_path.clp")
 (bind ?*path* (str-cat ?*path* "/miscellaneous/SMT/alignment/partial_word_match.clp"))
 (load ?*path*)
 (load-facts "word_alignment_tmp2.dat")
 (load-facts "confidence_level_tmp2.dat")
 (load-facts "anu_aligned_ids_tmp2.dat")
 (load-facts "man_aligned_ids_tmp2.dat")
 (load-facts "aper_op_without_@.dat")
 (load-facts "hindi_meanings.dat")
 (load-facts "manual_lwg.dat")
 (load-facts "revised_root.dat")
 ...
 (load-facts "manual_ids.dat")
 (run)
 (save-facts "word_alignment_tmp3.dat" local anu_id-anu_mng-sep-man_id-man_mng)
 (save-facts "confidence_level_tmp3.dat" local id-confidence_level)
 (save-facts "anu_aligned_ids.dat" local mng_has_been_filled)
 (save-facts "man_aligned_ids.dat" local mng_has_been_aligned)
 (clear)
 ;--------------------------------------------------------------------------
 (load "global_path.clp")
 (bind ?*path* (str-cat ?*path* "/miscellaneous/SMT/alignment/default_word_alignment_new.clp"))
 ...
 (load-facts "revised_root.dat")
 (load-facts "wx_agrep_output.dat")
 (load-facts "word_alignment_tmp3.dat")
 (load-facts "hindi_id_order.dat")
 (load-facts "confidence_level_tmp3.dat")
 (assert (delete_default_aligned_fact 0))
 (run)
 (save-facts "word_alignment_tmp4.dat" local anu_id-anu_mng-sep-man_id-man_mng)
 (save-facts "confidence_level.dat" local id-confidence_level)
 (clear)
 ;-----------------------------------------------------------------------------
 (load "global_path.clp")
 (bind ?*path* (str-cat ?*path* "/miscellaneous/SMT/alignment/replace_id_with_word.clp"))
 (load ?*path*)
 (load-facts "manual_word.dat")
 (load-facts "word_alignment_tmp4.dat")
 (run)
