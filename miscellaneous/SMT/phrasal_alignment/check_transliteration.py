...
#eng_lst=str(sys.argv[1])
#hnd_lst=str(sys.argv[2])
...
#                                                print("rAma:: max_eng_len =", max_eng_len)
                                                max_eng_len = eng_index
                                                #print("hari:: max_eng_len =", max_eng_len)
...
#					print '(OUTPUT: eng_word-tran_word ' , o[0], o[1],  ')'
					#print '(transliterate-word ' , o[0], o[1],  ')'
					break
#VC
				elif o[0] == eng.lower() and o[1] + 'a' == hnd:
					print  '(eng_word-tran_word ', o[0] , o[1] + 'a', ')'
#					print  '(OUTPUT eng_word-tran_word ', o[0] , o[1] + 'a', ')'
			break
