...
(defrule kriyA_mUla_3_words_using_dic
...
=>
	(assert (manual_word_info (head_id ?mid)(group_ids ?mid2 ?mid1 ?mid)))
	(assert (id-man_root ?mid ?root2 ?root1 ?r)) 
)
;----------------------------------------------------------------------------------------------------------
...
(defrule kriyA_mUla_2_words_using_dic
...
=>
	(assert (manual_word_info (head_id ?mid)(group_ids ?mid1 ?mid)))
	(assert (id-man_root ?mid ?word ?r))	
)
;----------------------------------------------------------------------------------------------------------
...
(defrule kriyA_mUla_with_vib_using_dic
...
=>
	(assert (manual_word_info (head_id ?mid)(group_ids ?mid1 ?mid)))
	(assert (id-man_root ?mid $?word ?v ?r))
)
;----------------------------------------------------------------------------------------------------------
...
(defrule kriyA_mUla_with_nahIM_using_dic
...
(or (database_info (components $?word ?r))(database_info (components $?word ho|kara) ))
=>
	(assert (manual_word_info (head_id ?mid)(group_ids ?mid2 ?mid1 ?mid)))
       	(assert (id-man_root ?mid $?word ?r))
)
