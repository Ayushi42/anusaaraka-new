...
(defrule get_transliterate_facts
(declare (salience 2002))
(elist $?sen)
=>
	...
	(system "python $HOME_anu_test/miscellaneous/SMT/phrasal_alignment/search_trnsltrtd_word.py trans_eng_file1.txt trans_hnd_file1.txt > trans_match.dat")
;	(system "python $HOME_anu_test/miscellaneous/SMT/phrasal_alignment/get_transliterate_wrds.py trans_eng_file1.txt trans_hnd_file1.txt $HOME_anu_test/miscellaneous/SMT/phrasal_alignment/Sound-list.txt out > trans_match.dat")
...
(man_word-root-cat ?kara&~hE kara|ho|karA|karavA|xe v)
...
(test (neq (integerp (member$ ?m (create$ wo hama lIjie yahAz apanA apanI))) TRUE)) 
...
?f0<-(anu_id-anu_mng-sep-man_id-man_mng_tmp ?id $?mng - ?mid $?mmng)
(not (anu_id-anu_mng-sep-man_id-man_mng_tmp ?id1 $?))
(not (added_group_end ?id))
(not (added_group_end ?id1))
=>
        (retract ?f0)
        (assert (anu_id-anu_mng-sep-man_id-man_mng_tmp ?id $?mng - ?mid @PUNCT-OpenParen@PUNCT-OpenParen $?mmng))
