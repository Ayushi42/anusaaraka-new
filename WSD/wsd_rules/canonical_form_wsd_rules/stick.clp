...
=>
(retract ?mng)
(assert (id-wsd_root_mng ?id CadI))
(if ?*debug_flag* then
...
=>
(retract ?mng)
(assert (id-wsd_root_mng ?id Guseda_xe))
(if ?*debug_flag* then
...
=>
(retract ?mng)
(assert (affecting_id-affected_ids-wsd_group_root_mng ?id ?id1 Apasa_me_juda ))
(if ?*debug_flag* then
...
=>
(retract ?mng)
(assert (affecting_id-affected_ids-wsd_group_root_mng ?id ?id1 Awafka_PElAkara_lUta_le ))
(if ?*debug_flag* then
