...
=>
(retract ?mng)
(assert (id-wsd_root_mng ?id Bojana));Automatically modified 'affecting_id-affected_ids-wsd_group_root_mng ?id ?id1' to 'id-wsd_root_mng ?id ' by Sukhada's program. 
(if ?*debug_flag* then
(printout wsd_fp "(dir_name-file_name-rule_name-id-wsd_root_mng  " ?*wsd_dir* " board.clp board0 " ?id "  Bojana )" crlf)) 
)
...
=>
(retract ?mng)
(assert (id-wsd_root_mng ?id waKwe_lagA));Automatically modified 'affecting_id-affected_ids-wsd_group_root_mng ?id ?id1' to 'id-wsd_root_mng ?id ' by Sukhada's program. 
(if ?*debug_flag* then
(printout wsd_fp "(dir_name-file_name-rule_name-id-wsd_root_mng  " ?*wsd_dir* " board.clp board2 " ?id "  waKwe_lagA )" crlf)) 
)
...
=>
(retract ?mng)
(assert (id-wsd_root_mng ?id maNdala))
(if ?*debug_flag* then
...
(assert (id-wsd_root_mng ?id waKwe_lagA));Automatically modified 'affecting_id-affected_ids-wsd_group_root_mng ?id ?id1' to 'id-wsd_root_mng ?id ' by Sukhada's program. 
(if ?*debug_flag* then
(printout wsd_fp "(dir_name-file_name-rule_name-id-wsd_root_mng  " ?*wsd_dir* " board.clp board6 " ?id "  waKwe_lagA )" crlf)) 
)
