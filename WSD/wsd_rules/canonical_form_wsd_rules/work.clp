...
=>
(retract ?mng)
(assert (id-wsd_root_mng ?id kadI_mehanawa_kara));Automatically modified 'affecting_id-affected_ids-wsd_group_root_mng ?id ?id1' to 'id-wsd_root_mng ?id ' by Sukhada's program. 
(if ?*debug_flag* then
(printout wsd_fp "(dir_name-file_name-rule_name-id-wsd_root_mng  " ?*wsd_dir* " work.clp work0 " ?id "  kadZI_mehanawa_kara )" crlf)) 
)
...
=>
(retract ?mng)
(assert (affecting_id-affected_ids-wsd_group_root_mng ?id ?id1 kadI_mehanawa_kara))
(if ?*debug_flag* then
