...
=>
(retract ?mng)
(assert (id-wsd_root_mng ?id SrqfKalA));seplling corrected
(if ?*debug_flag* then
...
=>
(retract ?mng)
(assert (id-wsd_root_mng ?id sikadI_bAzXa))
(if ?*debug_flag* then
...
=>
(retract ?mng)
(assert (id-wsd_root_mng ?id jaFjIra_se_bAzXa))
(if ?*debug_flag* then
...
=>
(retract ?mng)
(assert (id-wsd_root_mng ?id jaFjIra))
(if ?*debug_flag* then
