...
=>
(retract ?mng)
(assert (id-wsd_root_mng ?id kAra_Axi_ke_iMjana_kI_Sakwi_baDA));Automatically modified 'affecting_id-affected_ids-wsd_group_root_mng ?id ?id1' to 'id-wsd_root_mng ?id ' by Sukhada's program. 
(if ?*debug_flag* then
...
=>
(retract ?mng)
(assert (affecting_id-affected_ids-wsd_group_root_mng ?id ?id1 kAra_Axi_ke_iMjana_kI_Sakwi_baDA))
(if ?*debug_flag* then
...
=>
(retract ?mng)
(assert (id-wsd_root_mng ?id kAra_Axi_ke_iMjana_kI_Sakwi_baDA))
(if ?*debug_flag* then
