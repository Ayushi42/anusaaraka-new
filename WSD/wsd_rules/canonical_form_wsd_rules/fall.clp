...
=>
(retract ?mng)
(assert (affecting_id-affected_ids-wsd_group_root_mng ?id ?id1 piCada_jA))
(if ?*debug_flag* then
...
=>
(retract ?mng)
(assert (affecting_id-affected_ids-wsd_group_root_mng ?id ?id1 JagadA_kara))
(if ?*debug_flag* then
...
=>
(retract ?mng)
(assert (id-wsd_word_mng ?id pahAdI_ilAkA))
(if ?*debug_flag* then
