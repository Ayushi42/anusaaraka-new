...
(assert (id-wsd_root_mng ?id upayoga_kara))
(if ?*debug_flag* then
(printout wsd_fp "(dir_name-file_name-rule_name-id-wsd_root_mng   " ?*wsd_dir* "  employ.clp 	employ2   "  ?id "upayoga_kara  )" crlf))
)
...
(assert (id-wsd_root_mng ?id upayoga_kara))
(if ?*debug_flag* then
(printout wsd_fp "(dir_name-file_name-rule_name-id-wsd_root_mng   " ?*wsd_dir* "  employ.clp 	employ3   "  ?id "upayoga_kara  )" crlf))
)
...
;(assert (id-wsd_root_mng ?id upayoga_kara))
;(if ?*debug_flag* then
;(printout wsd_fp "(dir_name-file_name-rule_name-id-wsd_root_mng   " ?*wsd_dir* "  employ.clp 	employ13   "  ?id "upayoga_kara  )" crlf))
;)
;
...
=>
(retract ?mng)
(assert (id-wsd_root_mng ?id niyokwA))
(if ?*debug_flag* then
(printout wsd_fp "(dir_name-file_name-rule_name-id-wsd_root_mng   " ?*wsd_dir* "  employ.clp 	employ4   "  ?id " niyokZwA  )" crlf))
)
...
(if ?*debug_flag* then
(printout wsd_fp "(dir_name-file_name-rule_name-id-wsd_root_mng   " ?*wsd_dir* "  employ.clp 	employ5   "  ?id " niyukwa_kara )" crlf))
)
...
(if ?*debug_flag* then
(printout wsd_fp "(dir_name-file_name-rule_name-id-wsd_root_mng   " ?*wsd_dir* "  employ.clp 	employ7   "  ?id " lagA )" crlf))
)
...
(assert (id-wsd_root_mng ?id lagA))
(if ?*debug_flag* then
(printout wsd_fp "(dir_name-file_name-rule_name-id-wsd_root_mng   " ?*wsd_dir* "  employ.clp 	employ8   "  ?id " lagA )" crlf))
)
...
(assert (id-wsd_root_mng ?id laga))
(if ?*debug_flag* then
(printout wsd_fp "(dir_name-file_name-rule_name-id-wsd_root_mng   " ?*wsd_dir* "  employ.clp 	employ9   "  ?id " laga )" crlf))
)
...
(if ?*debug_flag* then
(printout wsd_fp "(dir_name-file_name-rule_name-id-wsd_root_mng   " ?*wsd_dir* "  employ.clp 	employ10   "  ?id " kAma_para_lagA )" crlf))
)
...
(if ?*debug_flag* then
(printout wsd_fp "(dir_name-file_name-rule_name-id-wsd_root_mng   " ?*wsd_dir* "  employ.clp 	employ11   "  ?id " nOkarI_xe )" crlf))
)
...
(if ?*debug_flag* then
(printout wsd_fp "(dir_name-file_name-rule_name-id-wsd_root_mng   " ?*wsd_dir* "  employ.clp 	employ12   "  ?id " nOkarI )" crlf))
)
...
(if ?*debug_flag* then
(printout wsd_fp "(dir_name-file_name-rule_name-id-wsd_root_mng   " ?*wsd_dir* "  employ.clp 	employ13   "  ?id " rojagAra )" crlf))
)
