...
=>
(retract ?mng)
(assert (id-wsd_root_mng ?id BIda))
(if ?*debug_flag* then
...
=>
(retract ?mng)
(assert (id-wsd_root_mng ?id jalxabAjI_kara))
(if ?*debug_flag* then
...
=>
(retract ?mng)
(assert (affecting_id-affected_ids-wsd_group_root_mng ?id ?id1 wejI_se_bahawe_hue_pAnI))
(if ?*debug_flag* then
...
=>
(retract ?mng)
(assert (affecting_id-affected_ids-wsd_group_root_mng ?id ?id1 wejI_se_bahawI_huI_Jarane))
(if ?*debug_flag* then
