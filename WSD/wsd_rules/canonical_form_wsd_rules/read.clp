...
=>
(retract ?mng)
(assert (id-wsd_word_mng ?id paDanA))
(if ?*debug_flag* then
...
=>
(retract ?mng)
(assert (affecting_id-affected_ids-wsd_group_root_mng ?id ?id1 paDa_kara_sunA))
(if ?*debug_flag* then
...
=>
(retract ?mng)
(assert (affecting_id-affected_ids-wsd_group_root_mng ?id ?id1 paDane_meM_acCA))
(if ?*debug_flag* then
