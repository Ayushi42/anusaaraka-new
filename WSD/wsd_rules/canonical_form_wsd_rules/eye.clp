...
=>
(retract ?mng)
(assert (id-wsd_word_mng ?id najara_gadAe_hue))
...
=>
(retract ?mng)
(assert (affecting_id-affected_ids-wsd_group_root_mng ?id (- ?id 1)  saBI_kI_najara))
(if ?*debug_flag* then
...
=>
(retract ?mng)
(assert (affecting_id-affected_ids-wsd_group_root_mng ?id (- ?id 1)  najara))
(if ?*debug_flag* then
