...
=>
(retract ?mng)
(assert (id-wsd_root_mng ?id Coda_xe));Automatically modified 'affecting_id-affected_ids-wsd_group_root_mng ?id ?id1' to 'id-wsd_root_mng ?id ' by Sukhada's program. 
(if ?*debug_flag* then
(printout wsd_fp "(dir_name-file_name-rule_name-id-wsd_root_mng  " ?*wsd_dir* " lay.clp lay2 " ?id "  CodZa_xe )" crlf)) 
)
...
=>
(retract ?mng)
(assert (affecting_id-affected_ids-wsd_group_root_mng ?id ?id1 xaPanAne_kI_wEyArI_kara))
(if ?*debug_flag* then
