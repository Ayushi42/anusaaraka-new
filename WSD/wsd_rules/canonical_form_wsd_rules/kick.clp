...
=>
(retract ?mng)
(assert (affecting_id-affected_ids-wsd_group_root_mng ?id ?id1 pade_raha))
(if ?*debug_flag* then
...
(if ?*debug_flag* then
(printout wsd_fp "(dir_name-file_name-rule_name-id-wsd_root_mng  " ?*wsd_dir* " kick.clp kick4 " ?id "  upaxrava )" crlf)) 
)
...
(assert (id-wsd_root_mng ?id upaxrava));Automatically modified 'affecting_id-affected_ids-wsd_group_root_mng ?id ?id1' to 'id-wsd_root_mng ?id ' by Sukhada's program. 
(if ?*debug_flag* then
(printout wsd_fp "(dir_name-file_name-rule_name-id-wsd_root_mng  " ?*wsd_dir* " kick.clp kick7 " ?id "  upaxrava )" crlf)) 
)
