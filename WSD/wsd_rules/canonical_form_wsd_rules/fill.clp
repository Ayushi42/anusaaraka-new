...
(if ?*debug_flag* then
(printout wsd_fp "(dir_name-file_name-rule_name-id-wsd_root_mng  " ?*wsd_dir* " fill.clp fill3 " ?id "  pUrA_kara )" crlf)) 
)
...
=>
(retract ?mng)
(assert (id-wsd_root_mng ?id BarA_huA_ho));Automatically modified 'affecting_id-affected_ids-wsd_group_root_mng ?id ?id1' to 'id-wsd_root_mng ?id ' by Sukhada's program. 
(if ?*debug_flag* then
(printout wsd_fp "(dir_name-file_name-rule_name-id-wsd_root_mng  " ?*wsd_dir* " fill.clp fill5 " ?id "  BarA_huA_ho )" crlf)) 
)
...
(assert (id-wsd_root_mng ?id BarA_huA_ho));Automatically modified 'affecting_id-affected_ids-wsd_group_root_mng ?id ?id1' to 'id-wsd_root_mng ?id ' by Sukhada's program. 
(if ?*debug_flag* then
(printout wsd_fp "(dir_name-file_name-rule_name-id-wsd_root_mng  " ?*wsd_dir* " fill.clp fill6 " ?id "  BarA_huA_ho )" crlf)) 
)
...
(assert (id-wsd_root_mng ?id BarA_huA_ho));Automatically modified 'affecting_id-affected_ids-wsd_group_root_mng ?id ?id1' to 'id-wsd_root_mng ?id ' by Sukhada's program. 
(if ?*debug_flag* then
(printout wsd_fp "(dir_name-file_name-rule_name-id-wsd_root_mng  " ?*wsd_dir* " fill.clp fill7 " ?id "  BarA_huA_ho )" crlf)) 
)
...
=>
(retract ?mng)
(assert (id-wsd_root_mng ?id Bara));Automatically modified 'affecting_id-affected_ids-wsd_group_root_mng ?id ?id1' to 'id-wsd_root_mng ?id ' by Sukhada's program. 
(if ?*debug_flag* then
(printout wsd_fp "(dir_name-file_name-rule_name-id-wsd_root_mng  " ?*wsd_dir* " fill.clp fill9 " ?id "  Bara )" crlf)) 
)
...
=>
(retract ?mng)
(assert (id-wsd_root_mng ?id sanwuRti))
(if ?*debug_flag* then
