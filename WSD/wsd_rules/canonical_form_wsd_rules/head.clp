...
=>
(retract ?mng)
(assert (id-wsd_root_mng ?id Age_baDakara_moda));Automatically modified 'affecting_id-affected_ids-wsd_group_root_mng ?id ?id1' to 'id-wsd_root_mng ?id ' by Sukhada's program. 
(if ?*debug_flag* then
...
=>
(retract ?mng)
(assert (affecting_id-affected_ids-wsd_group_root_mng ?id ?id1 Age_baDakara_moda))
(if ?*debug_flag* then
