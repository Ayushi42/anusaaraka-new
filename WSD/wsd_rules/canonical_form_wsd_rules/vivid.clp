...
(assert (id-wsd_root_mng ?id catakIlA))
(if ?*debug_flag* then
(printout wsd_fp "(dir_name-file_name-rule_name-id-wsd_root_mng " ?*wsd_dir* " vivid.clp   sub_samA_vivid0   "   ?id " catakIlA)" crlf))
)

;@@@ Added by Sukhada (12-05-14). Automatically generated this rule.
(defrule obj_samA_vivid0
(declare (salience 4900))
(id-root ?id vivid)
?mng <-(meaning_to_be_decided ?id)
...
(assert (id-wsd_root_mng ?id catakIlA))
(if ?*debug_flag* then
(printout wsd_fp "(dir_name-file_name-rule_name-id-wsd_root_mng " ?*wsd_dir* " vivid.clp   obj_samA_vivid0   "   ?id " catakIlA)" crlf))
)

;@@@ Added by Sukhada (12-05-14). Automatically generated this rule.
(defrule sub_samA_vivid2
(declare (salience 5000))
(id-root ?id vivid)
?mng <-(meaning_to_be_decided ?id)
(subject-subject_samAnAXikaraNa ?id1 ?id)
...
(assert (id-wsd_root_mng ?id gaharA))
(if ?*debug_flag* then
(printout wsd_fp "(dir_name-file_name-rule_name-id-wsd_root_mng " ?*wsd_dir* " vivid.clp   sub_samA_vivid2   "   ?id " gaharA)" crlf))
)

;@@@ Added by Sukhada (12-05-14). Automatically generated this rule.
(defrule obj_samA_vivid2
(declare (salience 5000))
(id-root ?id vivid)
?mng <-(meaning_to_be_decided ?id)
(object-object_samAnAXikaraNa ?id1 ?id)
...
(assert (id-wsd_root_mng ?id gaharA))
(if ?*debug_flag* then
(printout wsd_fp "(dir_name-file_name-rule_name-id-wsd_root_mng " ?*wsd_dir* " vivid.clp   obj_samA_vivid2   "   ?id " gaharA)" crlf))
)

;@@@ Added by Sukhada (12-05-14). Automatically generated this rule.
(defrule sub_samA_vivid3
(declare (salience 5000))
(id-root ?id vivid)
?mng <-(meaning_to_be_decided ?id)
(kriyA-subject  ?id2 ?id1)
(kriyA-object  ?id2 ?id3)
(subject-subject_samAnAXikaraNa ?id3 ?id)
(id-root ?id1 cheek)
(id-cat_coarse ?id adjective)
=>
(retract ?mng)
(assert (id-wsd_root_mng ?id -))
(if ?*debug_flag* then
(printout wsd_fp "(dir_name-file_name-rule_name-id-wsd_root_mng " ?*wsd_dir* " vivid.clp   sub_samA_vivid3   "   ?id " -)" crlf))
)

;@@@ Added by Sukhada (12-05-14). Automatically generated this rule.
(defrule obj_samA_vivid3
(declare (salience 5000))
(id-root ?id vivid)
?mng <-(meaning_to_be_decided ?id)
(kriyA-subject  ?id2 ?id1)
(kriyA-object  ?id2 ?id3)
(object-object_samAnAXikaraNa ?id3 ?id)
(id-root ?id1 cheek)
(id-cat_coarse ?id adjective)
=>
(retract ?mng)
(assert (id-wsd_root_mng ?id -))
(if ?*debug_flag* then
(printout wsd_fp "(dir_name-file_name-rule_name-id-wsd_root_mng " ?*wsd_dir* " vivid.clp   obj_samA_vivid3   "   ?id " -)" crlf))
)
