...
=>
(retract ?mng)
(assert (id-wsd_root_mng ?id xabafga))
(if ?*debug_flag* then
...
(assert (id-wsd_root_mng ?id nirBIka))
(if ?*debug_flag* then
(printout wsd_fp "(dir_name-file_name-rule_name-id-wsd_root_mng " ?*wsd_dir* " bold.clp   sub_samA_bold0   "   ?id " nirBIka )" crlf))
)
...
(assert (id-wsd_root_mng ?id nirBIka))
(if ?*debug_flag* then
(printout wsd_fp "(dir_name-file_name-rule_name-id-wsd_root_mng " ?*wsd_dir* " bold.clp   obj_samA_bold0   "   ?id " nirBIka )" crlf))
)
