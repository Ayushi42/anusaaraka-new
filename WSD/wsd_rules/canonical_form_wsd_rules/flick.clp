...
=>
(retract ?mng)
(assert (id-wsd_root_mng ?id kAgaja_palata));Automatically modified 'affecting_id-affected_ids-wsd_group_root_mng ?id ?id1' to 'id-wsd_root_mng ?id ' by Sukhada's program. 
(if ?*debug_flag* then
(printout wsd_fp "(dir_name-file_name-rule_name-id-wsd_root_mng  " ?*wsd_dir* " flick.clp flick0 " ?id "  kAgajZa_palata )" crlf)) 
)
...
(assert (id-wsd_root_mng ?id kAgaja_palata));Automatically modified 'affecting_id-affected_ids-wsd_group_root_mng ?id ?id1' to 'id-wsd_root_mng ?id ' by Sukhada's program. 
(if ?*debug_flag* then
(printout wsd_fp "(dir_name-file_name-rule_name-id-wsd_root_mng  " ?*wsd_dir* " flick.clp flick1 " ?id "  kAgajZa_palata )" crlf)) 
)
...
(assert (id-wsd_root_mng ?id kAgaja_palata));Automatically modified 'affecting_id-affected_ids-wsd_group_root_mng ?id ?id1' to 'id-wsd_root_mng ?id ' by Sukhada's program. 
(if ?*debug_flag* then
(printout wsd_fp "(dir_name-file_name-rule_name-id-wsd_root_mng  " ?*wsd_dir* " flick.clp flick2 " ?id "  kAgajZa_palata )" crlf)) 
)
...
=>
(retract ?mng)
(assert (affecting_id-affected_ids-wsd_group_root_mng ?id ?id1 kAgaja_palata))
(if ?*debug_flag* then
